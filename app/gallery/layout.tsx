...
export const metadata: Metadata = {
  ...
  keywords: "photos restaurant Lachute, galerie Bouillon 16, terrasse restaurant, ambiance gastronomique, plats signature photos, bar restaurant, équipe restaurant photos",
  openGraph: {
